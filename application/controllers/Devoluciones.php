...
if($this->session->userdata('tipo')=='admin'||'directorio')
 {
  $lista = $this->pedidodetalle_model->listapedido();
    ...
    $this->load->view('Devoluciones/devolucion_lista', $data);
  ...
  public function agregar()
  {
    ...
    $this->load->view('inc/headersbadmin');
    $this->load->view('inc/Sidebarsbadmin');
    $this->load->view('Devoluciones/devolucion_agregar', $data);
    $this->load->view('inc/creditos');
    $this->load->view('inc/footersbadmin');
  }
 ...
 function datos()
  ...
  public function modificar()
  {
    ...
    $this->load->view('inc/headersbadmin');
    $this->load->view('inc/Sidebarsbadmin');
    $this->load->view('Devoluciones/devolucion_modificar', $data);
    $this->load->view('inc/creditos');
    $this->load->view('inc/footersbadmin');
  }
  ...
  public function Anulados()
  {
    ...
    $this->load->view('inc/headersbadmin');
    $this->load->view('inc/Sidebarsbadmin');
    $this->load->view('Devoluciones/devolucion_anulados', $data);
    $this->load->view('inc/creditos');
    $this->load->view('inc/footersbadmin');
  }
  ...
  public function generarRecibo()
  {
    ...
    $this->load->view('inc/headersbadmin');
    $this->load->view('inc/Sidebarsbadmin');
    $this->load->view('Devoluciones/devolucion_recibo', $data);
    $this->load->view('inc/creditos');
    $this->load->view('inc/footersbadmin');
  }
