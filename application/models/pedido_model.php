...
class pedido_model extends CI_Model {
 ...
 function obtenerMaterialesMasPedidos() {
    ...
    function obtenerStock() {
     ...
     function obtenerMaestroSolicitante($startDate, $endDate) {
        $this->db->select('pd.* count(nombreMaestro)');
        $this->db->from('pdetalle pd');
        $this->db->where('nombreMaestro','nombreMaestro');               
        ...
        $this->db->order_by('pd.nombreMaestro', 'desc');
        return $this->db->get()->result_array();
    }
}
