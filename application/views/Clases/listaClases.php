 ...
 <!-- ============================================================== -->
   ...
   <small>CLASES</small>
               ...
               <div class="btn-group">
                  <button type="button" class="btn btn-primary " onclick="location.href='agregar'">Agregar Clase</button>
                        ...
                        <tbody>
                            ...
                            <?php 
                             ...
                             ?>
                                           ...
                                           <td>   
                                            <?php echo form_open_multipart('Clases/modificar');?>
                                            ...
                                            <td>   
                                            <?php echo form_open_multipart('Clases/eliminarbd');?>
                                            <input type="hidden" name="idClase" value="<?php echo $row->idClase;?>">
                                            <input type="submit" name="buttonx" value="Eliminar" class="btn btn-danger"></input>
                                            <?php echo form_close();?>
                                            </td>
                                            <td>   
                                            <?php echo form_open_multipart('Clases/deshabilitarbd');?>
                                            <input type="hidden" name="idClase" value="<?php echo $row->idClase;?>">
